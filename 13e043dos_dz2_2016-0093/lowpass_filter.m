function [ b, a ] = lowpass_filter( fs, fa, fp, Aa, Ap )
%lowpass_filter
...
%provera gabarita
    ...
    ia=ceil(fa/df)+1;
    ip=floor(fp/df)+1;
    Ha=Hd(ia:end);               %Amplitudska Karakteristika Nepropusnog Opsega
...
%---Amplitudska karakteristika digitalnog filtra u linearnoj razmeri
        ...
        hold on
            x_1_g = [fa fs/2];    y_1_g = [delta_ag delta_ag];
            x_1 = [fa fs/2];      y_1 = [delta_a delta_a];
            x_2 = [fa fa];	y_2 = [delta_a 1-delta_p];
            
            x_3 = [0  fp];	y_3 = [1-delta_p 1-delta_p];
        ...
        % crtanje POOSTRENIH gabarita
            ...
            x_1v = [fa fs/2];      y_1v = [delta_a delta_a];
            x_2v = [fa fa];	y_2v = [delta_a 10^(-0.05*Aa)];
            
            x_3v = [0  fp];	y_3v = [1-delta_p 1-delta_p];
...
%---Amplitudska karakteristika digitalnog filtra u logaritamskoj razmeri
        ...
        % crtanje DATIH gabarita
            ...
            x_1_g = [fa fs/2];    y_1_g = [-Aag -Aag];
            x_1 = [fa fs/2];    y_1 = [-Aa -Aa];
            x_2 = [fa fa];      y_2 = [-Aa -Ap];

            x_3 = [ 0 fp];      y_3 = [-Ap -Ap];
            x_4 = [fp fp];      y_4 = [-Aa -Ap];
        % crtanje POOSTRENIH gabarita
            x_1v = [fa fs/2];       y_1v = [-Aatemp -Aatemp];
            x_2v = [fa fa];      y_2v = [-Aa -Aatemp];

            x_3v = [ 0 fp]; 	y_3v = [-Aptemp -Aptemp];
...
%---Amplitudska karakteristika pomocu semilogx
        ...
        hold on
            ...
            x_3 = [fp*1e-3 fp];        y_3 = [-Ap -Ap];
            x_4 = [fp fp];          y_4 = [-Aa -Ap];
        % crtanje POOSTRENIH gabarita
            x_1v = [fa fs/2];    y_1v = [-Aatemp -Aatemp];
            x_2v = [fa fa];         y_2v = [-Aatemp -Aa];

            x_3v = [fp*1e-2 fp];       y_3v = [-Aptemp -Aptemp];
            x_4v = [fp fp];         y_4v = [-Ap -Aptemp];
